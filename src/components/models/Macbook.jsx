...
Files: macbook.glb [629.72KB] > D:\projects\Apple\public\models\macbook-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel(props) {
  const { nodes, materials } = useGLTF('/modles/macbook-transformed.glb');
